...
public class OuterClimberLeftTiltCommand extends CommandBase {
  private OuterClimberSubsystem outerClimberSubsystem;

  /** Creates a new OuterClimberLeftTiltCommand. */
  public OuterClimberLeftTiltCommand(OuterClimberSubsystem outerClimberSubsystem) {
  ...
  @Override
  public void execute() {
    SmartDashboard.putNumber("helloooo", 0.45);
  }
