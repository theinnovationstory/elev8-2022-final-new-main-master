...
public class IntakeStartCommand extends CommandBase {
  ...
  public IntakeStartCommand(IntakeStarterSubsystem intakeStarterSubsystem) {
  ...
  public void initialize() {
    this.intakeStarterSubsystem.setAngle();
  }
  ...
  public void end(boolean interrupted) {
    this.intakeStarterSubsystem.setSpeed(0.6);
  }

  // Returns true when the command should end.
  @Override
  public boolean isFinished() {
    return !RobotContainer.dpadButtonUp_JoyD();
  }
}
