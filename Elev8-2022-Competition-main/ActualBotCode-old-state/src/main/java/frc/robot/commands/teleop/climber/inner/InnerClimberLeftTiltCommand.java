...
public class InnerClimberLeftTiltCommand extends CommandBase {
  private InnerClimberSubsystem innerClimberSubsystem;

  /** Creates a new ClimberIntakeLeftTiltCommand. */
  public InnerClimberLeftTiltCommand(InnerClimberSubsystem innerClimberSubsystem) {
  ...
  public boolean isFinished() {
    return !RobotContainer.joyD.getRawButton(3);
  }
}
